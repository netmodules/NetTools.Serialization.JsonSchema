...
namespace NetTools.Serialization.JsonSchemaEnums
{
    ...
    {
        /// <summary>
        /// The (none) format is a custom format added by NetTools.Serialization.JsonSchemaAttributes to allow a default if the attribute field is not set
        /// by the declarer.
        /// </summary>
        None = 0,

        /// <summary>
        /// Custom format added by NetTools.Serialization.JsonSchemaAttributes: // ISO 8601 Duration should be formatted as P[n]Y[n]M[n]DT[n]H[n]M[n]S.
        /// See <see href="https://en.wikipedia.org/wiki/ISO_8601">Durations</see>
        /// </summary>
        Duration,

        /// <summary>
        /// Custom format added by NetTools.Serialization.JsonSchemaAttributes: This tells the formatter that this string should span across multiple lines
        /// and should be displayed in a textarea rather than a text field.
        /// </summary>
        Multiline,

        /// <summary>
        /// Custom format added by NetTools.Serialization.JsonSchemaAttributes: This tells the formatter that this string is a Base 64 string representation
        ...
        /// <summary>
        /// Custom format added by NetTools.Serialization.JsonSchemaAttributes: This tells the formatter that this string is a CSV string representation of
        ...
        /// <summary>
        /// Custom format added by NetTools.Serialization.JsonSchemaAttributes: This tells the formatter that this string is an XML representation of
        /// an object. This may allow the formatter to display an XML formatter or validator view, for example.
        /// </summary>
        Xml,

        /// <summary>
        /// Custom format added by NetTools.Serialization.JsonSchemaAttributes: This tells the formatter that this string is an HTML representation of
        /// an object. This may allow the formatter to display an HTML formatter or validator view, for example.
        /// </summary>
        Html,

        /// <summary>
        /// Custom format added by NetTools.Serialization.JsonSchemaAttributes: This tells the formatter that this string is a JSON representation of
        /// an object. This may allow the formatter to display a JSON formatter or validator view, for example.
        /// </summary>
        Json,

        /// <summary>
        /// Custom format added by NetTools.Serialization.JsonSchemaAttributes: This tells the formatter that this string is a rich text string representation of
        ...
        /// <summary>
        /// Custom format added by NetTools.Serialization.JsonSchemaAttributes: This tells the formatter that this string represents an HTML Color. This
